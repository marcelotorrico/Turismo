 ...
 */
class Paquete extends \MTD\TurismoBundle\Entity\Paquete implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'MTD\\TurismoBundle\\Entity\\Paquete' . "\0" . 'id', '' . "\0" . 'MTD\\TurismoBundle\\Entity\\Paquete' . "\0" . 'imagen', '' . "\0" . 'MTD\\TurismoBundle\\Entity\\Paquete' . "\0" . 'nombre', '' . "\0" . 'MTD\\TurismoBundle\\Entity\\Paquete' . "\0" . 'lugar', '' . "\0" . 'MTD\\TurismoBundle\\Entity\\Paquete' . "\0" . 'precio', '' . "\0" . 'MTD\\TurismoBundle\\Entity\\Paquete' . "\0" . 'descripcion', '' . "\0" . 'MTD\\TurismoBundle\\Entity\\Paquete' . "\0" . 'usuario');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Paquete $proxy) {
